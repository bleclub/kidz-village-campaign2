...
<head>
<meta charset="utf-8">
<title>Thank you for your information - Kidz Village</title>
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="author" content="Kidz Village">
  ...
  <link rel="stylesheet" href="../js/presentational-only/presentational-only.css">
  ...
  <script src="../js/presentational-only/presentational-only.js"></script>
...
<body>
  ...
  <header class="container">
    <section class="content">
      ...
      <p class="sub-title"><strong>A Kidz Village representative will be in touch with you shortly.<br>Please <a href="http://www.kidz-village.ac.th/" style="color:#fff;" >click here</a> to go to Kidz Village website.</p></p>
